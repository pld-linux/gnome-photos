...
Source0:	http://ftp.gnome.org/pub/GNOME/sources/gnome-photos/3.24/%{name}-%{version}.tar.xz
# Source0-md5:	e945aee82baacf29f3a7c1ef59bfd849
...
BuildRequires:	gegl-devel >= 0.3.14
